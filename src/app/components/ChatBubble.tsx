    ...
    <AnimatePresence>
      {visible && (
        <motion.div
          ...
          className={`absolute ${position === 'above' ? 'bottom-full left-1/2 translate-x-1/8 mb-2' : 'top-full left-1/2 -translate-x-1/2 mt-2'} z-40 pointer-events-none`}
          style={{ minWidth: '60px', maxWidth: '220px' }}
        >
          <div className="bg-white text-gray-900 text-[18px] font-semibold px-2.5 py-1.5 rounded-xl shadow-[0_8px_28px_rgba(0,0,0,0.8)] text-center leading-tight break-words relative">
            {position === 'above' ? (
